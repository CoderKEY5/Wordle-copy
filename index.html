...
word_list = ['livre','doigt','heure','froid','danse','arbre','lundi','orage','bisou','chien','chiot','aigle','lapin','court','merci','blanc','salut','verre','voire','chair','short','veste','grand','pomme','gomme','avoir','autre','temps','trois','aussi','terre','jenre','image','monde','vivre','forme','juste','aider','ligne','avant','droit','vivux','quand','votre','faire','pizza','biere','pates','aimer','porte']
